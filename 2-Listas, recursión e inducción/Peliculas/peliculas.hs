...
-- a) Definí la función verTodas : [(String, Int, Int, String)] → Int que dada una lista de películas 
-- devuelva el tiempo que tardaría en verlas a todas.

verTodas:: [(String, Int, Int, String)] -> Int 
verTodas [] = 0
verTodas ((nombre,anioEstreno,duracion,director):xs) = duracion + verTodas xs

-- b) Definí la función filtrarAño : [(String, Int, Int, String)] → [String] que dada una lista de películas
-- devuelva el listado de películas que estrenaron en x año.

filtrarAnio:: Int -> [(String,Int,Int,String)]->[String]
filtrarAnio anio [] = []
filtrarAnio anio ((nombre,anioEstreno,duracion,director):xs)
    | anioEstreno == anio = nombre : filtrarAnio anio xs
    | otherwise = filtrarAnio anio xs

-- c) Definí la función filmografia : [(String, Int, Int, String)] → String → [String] que dada una lista de
-- películas y el nombre de un director, devuelva el listado de películas de ese director.
             
filmografia:: [(String,Int,Int,String)] -> String -> [String]
filmografia [] _ = []
filmografia ((nombre,anioEstreno,duracion,director):xs) directorBuscado 
    | director == directorBuscado = nombre : filmografia xs directorBuscado
    | otherwise = filmografia xs directorBuscado

-- d)  Definí la función duracion : [(String, Int, Int, String)] → String → Int que dada una lista de
-- películas y el nombre de una película, devuelva la duracion de esa película.

duracion:: [(String,Int,Int,String)]-> String ->Int 
duracion [] _ = 0
duracion ((nombre,anioEstreno,duracionP,director):xs) nombreBuscado
    | nombre == nombreBuscado = duracionP
    | otherwise = duracion xs nombreBuscado
